...
<body>
	<header>
		...
		<h3>Prevalensi Positif Covid-19 di Indonesia</h3>
	</header>
...
function style(f) {
	...
	return {
		...
		dashArray: '3',
		fillOpacity: 0.7,
		fillColor: getColor(data.pr_positif)
	};
}
// update jika hover
...
// update info
  ...
  function onEachFeature(f, layer) {
		...
		var popUp='<table>'+
					...
					'<tr>'+
						'<td class="bg-danger"></td>'+
						'<td>Prevalensi Positif</td>'+
						'<td>'+data.pr_positif+'</td>'+
					'</tr>'+
					'</table>';
  		...
  		success:function(data){
  			...
  			for (i=0;i<features.length;i++) {
				...
				var list='<h5>'+attributes.kabupaten+'</h5>'+
							...
							'<span class="text-danger">Prevalensi Positif : '+attributes.pr_positif+'</span>'+
